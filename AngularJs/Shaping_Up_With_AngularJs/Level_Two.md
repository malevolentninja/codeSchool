...
A product has an array of images we can use in our HTML.
Let's get the first image to show on the page!
...
In this case the images array will just be empty.
Note the change in our gems array.
...
- An empty Controller isn't much use. Do you remember why we needed a Controller at all? That's right, we need to initialize the tab property. 
...
We've provided all the HTML for you. 
...
Now that you're such a whiz with tabbed tab,
can you apply what you've learned to our image gallery,
too? 
Don't worry, we'll start slow… 
And there's a lot more in common than you might think!
